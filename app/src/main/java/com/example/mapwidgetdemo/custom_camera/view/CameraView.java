package com.example.mapwidgetdemo.custom_camera.view;
...
import com.example.mapwidgetdemo.custom_camera.camerainterface.CameraOperations;
import com.example.mapwidgetdemo.custom_camera.cameramanager.Camera1Manager;
import com.example.mapwidgetdemo.custom_camera.cameramanager.Camera2Manager;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case Constants.RECORD_STOP_LOW_MEMORY:
                    ...
                    rotationAngle = 0f;
                    videoFragment.stopRecordAndSaveFile(false);
                    break;
            }
        }
    }
...
//            if(VERBOSE)Log.d(TAG,"Rotation in CAMVIEW = "+totalRotation);
    ...
    public void capturePhoto() {
        ...
        if (VERBOSE)
            Log.d(TAG, "Shutter sound before click? = " + sharedPreferences.getBoolean(Constants.SHUTTER_SOUND, true));
        ...
        class CameraHandler extends Handler {
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what) {
                    ...
                    case Constants.RECORD_STOP_NEW:
                        try {
                            mediaRecorder.stop();
                        } catch (RuntimeException runtime) {
                            if (VERBOSE)
