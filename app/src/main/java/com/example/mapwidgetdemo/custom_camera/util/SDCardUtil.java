package com.example.mapwidgetdemo.custom_camera.util;
...
public class SDCardUtil {
    ...
    //Check if the com.example.mapwidgetdemo.custom_camera folder that is created for FlipCam application exists or was removed.
    ...
    //Check if the com.example.mapwidgetdemo.custom_camera folder that is created is empty or contains media.
